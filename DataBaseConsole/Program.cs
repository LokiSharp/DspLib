...
insertDatabaseCommand.SetHandler(
    async (host, database, username, password, startSeed, maxSeed, starCount, environment) =>
        await InsertDatabase(host!, database!, username!, password!, startSeed, maxSeed, starCount, environment),
...
async Task InsertDatabase(string host, string database, string username, string password, int startSeed, int maxSeed,
