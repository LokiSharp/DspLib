...
public struct Vector4 : IEquatable<Vector4>
{
    ...
    public static Vector4 zero { get; } = new(0f, 0f, 0f, 0f);

    public static Vector4 one { get; } = new(1f, 1f, 1f, 1f);

    public static Vector4 positiveInfinity { get; } = new(float.PositiveInfinity, float.PositiveInfinity,
        float.PositiveInfinity, float.PositiveInfinity);

    public static Vector4 negativeInfinity { get; } = new(float.NegativeInfinity, float.NegativeInfinity,
    ...
    {
        return new Vector4(Mathf.Min(lhs.x, rhs.x), Mathf.Min(lhs.y, rhs.y), Mathf.Min(lhs.z, rhs.z),
            Mathf.Min(lhs.w, rhs.w));
    }

    public static Vector4 Max(Vector4 lhs, Vector4 rhs)
    {
        return new Vector4(Mathf.Max(lhs.x, rhs.x), Mathf.Max(lhs.y, rhs.y), Mathf.Max(lhs.z, rhs.z),
